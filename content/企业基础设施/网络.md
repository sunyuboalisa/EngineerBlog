...
#### Step1 下载 Gitea for Windows

在 GitHub 搜索 [Gitea](https://github.com/go-gitea/gitea) 项目下载发布版本，或直接在 [Gitea官网](https://about.gitea.com/) 下载对应操作系统的安装程序。

#### Step 2 设置配置文件

参照 [[#gitea配置文件|gitea配置文件]] 节。
...
之后可以通过以下命令启动它，也可以运行 services.msc 在 Windows 服务管理界面管理该服务。
``` cmd
net start gitea
```
